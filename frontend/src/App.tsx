...
>>>>>>> UNew
              ...
              <div className="flex justify-between">
                ...
                <button
                  ...
                  className="px-8 py-2.5 bg-emerald-600 text-white rounded-lg font-medium hover:bg-emerald-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? 'Finding Recipes...' : `See Recipes (${confirmedIngredients.length} selected)`}
                </button>
              </div>
            </div>
          )}
              ...
              <div>
                <div className="flex items-start justify-between mb-8">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h2 className="text-3xl font-bold text-gray-900">Your Final Recipes</h2>
                      <p className="text-gray-600 mt-1">
                        {likedRecipes.length} favourite recipes • Goal: {userProfile.goal || 'N/A'}
                      </p>
                      <p className="text-xs text-gray-500 mt-1">
                        Only recipes you liked are shown here.
                      </p>
                    </div>
                  </div>
                ...
                {likedRecipes.length === 0 ? (
                  <div className="bg-blue-50 border border-blue-200 rounded-2xl p-10 text-center">
                    ...
                    <h3 className="text-xl font-bold text-blue-900 mb-2">No favourites yet</h3>
                    <p className="text-blue-800 mb-4 text-sm">
                      Go back, like a few recipes you love, and they’ll appear here.
                    </p>
                    <button
                      onClick={() => setCurrentStep('recipes1')}
...
<<<<<<< HEAD
                        ...
                        {recipeDetails.protein_g !== null &&
                          recipeDetails.protein_g !== undefined && (
                            <div>
                              <div className="text-2xl font-bold text-blue-700">
                                {recipeDetails.protein_g !== null
                                  ? Math.round(recipeDetails.protein_g)
                                  : 0}
                                g
                              </div>
                        ...
                        {recipeDetails.carbs_g !== null &&
                          recipeDetails.carbs_g !== undefined && (
                            <div>
                              <div className="text-2xl font-bold text-purple-700">
                                {recipeDetails.carbs_g !== null
                                  ? Math.round(recipeDetails.carbs_g)
                                  : 0}
                                g
                              </div>
                        ...
                        {recipeDetails.fat_g !== null &&
                          recipeDetails.fat_g !== undefined && (
                            <div>
                              <div className="text-2xl font-bold text-amber-700">
                                {recipeDetails.fat_g !== null
                                  ? Math.round(recipeDetails.fat_g)
                                  : 0}
                                g
                              </div>
                    ...
                    <div>
                      ...
                      <ol className="space-y-3">
                        {recipeDetails.steps.map((step: string, idx: number) => (
                          <li
                            key={idx}
                            className="flex gap-4 p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-all"
                          >
